                            ...
                            case (byte)TDSPacketType.RESPONSE:  //0x4
                                {
                                    ...
                                    else if (fd.payload[8] == (byte)TDSTokenType.PRELOGINRESPONSE) // only 1 token in the payload
                                    {
                                        ...
                                        c.PreLoginResponseTime = fd.ticks;
